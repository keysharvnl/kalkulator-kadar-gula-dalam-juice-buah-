...
st.markdown(
    ...
    <div class="selamat-datang">
        ...
        <p style='color: #333333; text-align:justify;'>Aplikasi ini dirancang untuk membantu Anda menghitung jumlah kadar gula dalam berbagai jenis buah sebanyak 250mL yang mengandung sekitar 225ml air. 
...
kadargula_buah = {
    'alpukat': {'kadar gula': 2, 'vitamin': {'Vitamin K': '26%', 'Vitamin E': '14%'}},
    'apel': {'kadar gula': 24, 'vitamin': {'Vitamin A': '3%', 'Vitamin C': '14%'}},
    'blueberry': {'kadar gula': 35, 'vitamin': {'Vitamin C': '11%', 'Vitamin A': '1%'}},
    'buah naga': {'kadar gula': 15, 'vitamin': {'Vitamin C': '9%', 'Vitamin B3': '8%'}},
    'jeruk': {'kadar gula': 21, 'vitamin': {'Vitamin C': '90%'}},
    'kiwi': {'kadar gula': 20, 'vitamin': {'Vitamin C': '112%', 'Vitamin K': '38%'}},
    'lemon': {'kadar gula': 6, 'vitamin': {'Vitamin C': '59%'}},
    'mangga': {'kadar gula': 30, 'vitamin': {'Vitamin A': '25%', 'Vitamin C': '76%'}},
    'markisa': {'kadar gula': 30, 'vitamin': {'Vitamin C': '33%', 'Vitamin A': '7%'}},
    'melon': {'kadar gula': 12, 'vitamin': {'Vitamin A': '12%', 'Vitamin C': '61%'}},
    'nanas': {'kadar gula': 30, 'vitamin': {'Vitamin C': '80%', 'Vitamin B1': '7%'}},
    'pepaya': {'kadar gula': 36, 'vitamin': {'Vitamin C': '67%', 'Vitamin A': '19%'}},
    'pisang': {'kadar gula': 24, 'vitamin': {'Vitamin B6': '20%', 'Vitamin C': '14%'}},
    'pir': {'kadar gula': 12, 'vitamin': {'Vitamin C': '7%'}},
    'semangka': {'kadar gula': 9, 'vitamin': {'Vitamin A': '11%', 'Vitamin C': '13%'}},
    'sirsak': {'kadar gula': 12, 'vitamin': {'Vitamin C': '24%', 'Vitamin B6': '5%'}},
    'strawberry': {'kadar gula': 13, 'vitamin': {'Vitamin C': '98%'}},
    'tomat': {'kadar gula': 7, 'vitamin': {'Vitamin C': '15%', 'Vitamin A': '28%'}},
}
